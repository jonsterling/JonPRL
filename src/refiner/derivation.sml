...
struct
  ...
  fun toString theta =
    case theta of
       ...
       | EQ_MEMBER_EQ => "eq-mem⁼"
       | CEQUAL_EQ => "cequal-eq"
       | CEQUAL_MEMBER_EQ => "cequal-mem-eq"
       | CEQUAL_SYM => "cequal-sym"
       | CEQUAL_STEP => "cequal-step"
       | CEQUAL_SUBST => "cequal-subst"
       | CEQUAL_STRUCT _ => "cequal-struct"
       | CEQUAL_APPROX => "cequal-approx"
       | CEQUAL_ELIM => "cequal-elim"
       | APPROX_EQ => "approx-eq"
       | APPROX_MEMBER_EQ => "approx-mem-eq"
       | APPROX_EXT_EQ => "approx-ext-eq"
       | APPROX_REFL => "approx-refl"
       | APPROX_ELIM => "approx-elim"
