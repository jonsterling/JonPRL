...
sig
  ...
  structure Rules : sig
    ...
    (* H >> IR(I;O) ext σ(o) by InductionRecursionIntroIota
     *   H >> O ext o
     *   H >> I ∈ U{k}
     *)
    val InductionRecursionIntroIota : Level.t option -> tactic

    (* H >> IR(I;O) ext σ(s. E) by InductionRecursionIntroSigma S x k
     *   H >> S ∈ U{k}
     *   H, x : S >> IR(I;O) ext E
     *)
    val InductionRecursionIntroSigma : term * name option * Level.t option -> tactic

    (* H >> IR(I;O) ext δ(f. E) by InductionRecursionIntroDelta S x k
     *   H >> S ∈ U{k}
